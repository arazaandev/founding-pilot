...
export async function POST(req:Request){try{
  ...
  try{
    await sendApplicationEmails({fullName:body.fullName,workEmail:body.workEmail,agencyName:body.agencyName,jobTitle:body.jobTitle,specializations:body.specializations,paidPilotReadiness:body.paidPilotReadiness,weeklyFeedbackAvailability:body.weeklyFeedbackAvailability});
  }catch(error){
    console.error("Non-blocking email failure",error);
  }
