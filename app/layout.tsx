...
export const metadata:Metadata={
  ...
  openGraph:{title:siteConfig.name,description:"Know which companies to approach this week—and why now.",type:"website",images:[{url:"/og.png",width:1728,height:902,alt:"LANCARA opportunity intelligence"}]},
